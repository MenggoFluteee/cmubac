...
@section('content')
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header text-end">
                            <button type="button" class="btn btn-success" id="budgetAddNewAccountCodeButton"><i
    ...
    <div class="modal fade" id="addNewAccountCodeModal" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <form id="addNewAccountCodeForm" action="{{ route('budgetOfficeAddAccountCode') }}" method="POST">
                    @csrf
    ...
    <div class="modal fade" id="editAccountCodeModal" tabindex="-1" role="dialog" aria-labelledby="editAccountCodeModal"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <form id="editAccountCodeForm" action="{{ route('budgetOfficeUpdateAccountCode') }}" method="POST">
                    @csrf
                    <div class="modal-body mx-3">
    ...
    <script type="text/javascript">
        ...
        function refreshAccountCodeTable() {
            ...
            $.ajax({
                url: "{{ route('budgetOfficeFetchAccountCodes') }}",
                type: 'POST',
                dataType: 'json',
                data: {
                    _token: "{{ csrf_token() }}",
    ...
    <script>
        $('#budgetAddNewAccountCodeButton').click(function() {
        ...
        $('#addNewAccountCodeForm').on('submit', function(e) {
            ...
            $.ajax({
                url: "{{ route('budgetOfficeAddAccountCode') }}",
                type: 'POST',
                data: {
                    _token: "{{ csrf_token() }}",
        ...
        $('#editAccountCodeForm').on('submit', function(e) {
            ...
            $.ajax({
                url: "{{ route('budgetOfficeUpdateAccountCode') }}",
                type: 'POST',
                data: {
                    _token: "{{ csrf_token() }}",
        ...
        function deleteAccountCode(accountCodeId, accountCodeName) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: "{{ route('budgetOfficeDeleteAccountCode') }}", // URL is static
                        type: 'POST',
                        dataType: 'JSON',
                        data: {
